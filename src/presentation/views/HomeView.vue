...
<template>
  <main class="flex min-h-full flex-col items-center justify-center gap-8 p-6">
    ...
    <button
      type="button"
      class="rounded-xl bg-indigo-500 px-6 py-3 text-lg font-semibold text-white shadow-lg shadow-indigo-500/30 transition hover:bg-indigo-400 active:scale-95"
      disabled
    >
      Nouvelle partie
    </button>
